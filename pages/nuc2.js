...
import { GetWeatherHere, GetWeatherIndexJS, GetWeatherNUC2, wunderground} from './api/weather';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    var timer = setInterval(function(){
        GetWeatherNUC2(setWeather);
      wunderground(`${process.env.NEXT_PUBLIC_WUNDERGROUND}`,`${process.env.NEXT_PUBLIC_STATIONID_NUC_2}`,setRealWeather)
    }
